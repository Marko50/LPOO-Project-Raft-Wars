...
public class Hero  extends Character {
	...
	public Hero(int x, int y, char im) {
		...
		try {
			...
			System.out.print("HeroMoveRight sprite not found\n");
		}
		setHasKey(false);
		...
		if (hasKey)
			...
			if(order == 'w')
	    	{
	    		try {
					...
					System.out.print("HeroMoveUp sprite not found\n");
				}
	    	}
	    	else if(order == 'a') {
	    		try {
					...
					System.out.print("HeroMoveLeft sprite not found\n");
				}	
	    	}
	    	else if(order == 's') {
	    		try {
					...
					System.out.print("HeroMoveDown sprite not found\n");
				}
	    	}
	    	else if(order == 'd') {
	    		try {
